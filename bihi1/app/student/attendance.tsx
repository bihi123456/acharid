  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={[styles.attendanceIcon, pulseEffect && styles.pulse]}>
          <IconSymbol
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.infoItem}>
            ...
            <Text style={styles.infoText}>Your professor activates attendance during class</Text>
          </View>
          <View style={styles.infoItem}>
            <IconSymbol name="2.circle" size={20} color={colors.primary} />
            <Text style={styles.infoText}>You mark yourself as present using this screen</Text>
          </View>
          <View style={styles.infoItem}>
